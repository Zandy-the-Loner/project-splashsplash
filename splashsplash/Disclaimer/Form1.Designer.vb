...
Partial Class Form1
    ...
    Private Sub InitializeComponent()
        ...
        Me.Button1.Text = "I know what I'm doing."
        ...
        Me.Label1.Text = "The program you just executed does this."
        '
        'Label2
        '
        ...
        Me.Label2.Text = "Don't do this, and Note this."
        '
        'Label3
        '
        Me.Label3.AutoSize = True
        Me.Label3.Location = New System.Drawing.Point(86, 55)
        Me.Label3.Name = "Label3"
        Me.Label3.Size = New System.Drawing.Size(254, 13)
        Me.Label3.TabIndex = 3
        Me.Label3.Text = "If you thought x, click the X and nothing will happen."
        '
        'Label4
        '
        ...
        Me.Label4.Text = "Are you sure you want to do this?"
        '
        'Form1
        '
